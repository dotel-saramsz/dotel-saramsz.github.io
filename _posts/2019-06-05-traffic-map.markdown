...
{% include image.html image_center="true" url="/assets/img/traffic/blockdiagram.png" description="Fig: Block diagram of the expected traffic mobility analysis system." %}
